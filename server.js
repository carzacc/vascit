...
(function() {
  'use strict';
  var LocalStrategy, MongoClient, adminbar, adminhead, aiutaci, amministratore, app, bcrypt, bodyParser, compression, connessione, crypto, elaboracomune, elaboraregione, escapeHtml, express, expressValidator, fs, head, helmet, http, mongo, mostradati, mysql, navbar, passport, scripts, start, trovato, util;
  ...
  app.listen(process.env.PORT, function() {
    ...
    return MongoClient.connect(process.env.MONGODB_URI, function(err, db) {
      ...
      return db.createCollection("customers", function(err, res) {
        if (err) {
          throw err;
        }
