...
(function() {
  'use strict';
  var aiutaci, app, bodyParser, compression, connessione, elaboracomune, elaboraregione, escapeHtml, express, expressValidator, fs, head, helmet, http, mostradati, mysql, navbar, scripts, start, util;
  ...
  //console.log req.get
  //next();
  app.get('/aiutaci.html', function(req, res) {
    res.writeHead(200, {
